...
Complete setup for a build with Apio tools under Win10/Win11.
...
0. you must have the Apio installed
1. copy the Apio version files into a directory
2. cd to the directory and build it with "apio build"
3. details with "apio report -v"
4. uploading the bitstream not tested yet.
