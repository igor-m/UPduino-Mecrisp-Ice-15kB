...
\ for UPduino Board IgorM 14-Mar-2018, 8kB version!
...
: ms   ( u -- ) 0 do 2178 0 do loop loop ; \ 11 cycles per loop run.. For 24 MHz / 11 = 2178
...
\ For 8kB of ram, interrupt vectors placed at the end of ram
$608C $1FFE ! \ Location $1FFE is an interrupt vector 7 ! Place ALU exit opcode here.
$608C $1FFC ! \ Location $1FFC is an interrupt vector 6 ! Place ALU exit opcode here.
$608C $1FFA ! \ Location $1FFA is an interrupt vector 5 ! Place ALU exit opcode here.
$608C $1FF8 ! \ Location $1FF8 is an interrupt vector 4 ! Place ALU exit opcode here.
$608C $1FF6 ! \ Location $1FF6 is an interrupt vector 3 ! Place ALU exit opcode here.
$608C $1FF4 ! \ Location $1FF4 is an interrupt vector 2 ! Place ALU exit opcode here.
$608C $1FF2 ! \ Location $1FF2 is an interrupt vector 1 ! Place ALU exit opcode here.
$608C $1FF0 ! \ Location $1FF0 is an interrupt vector 0 ! Place ALU exit opcode here.
